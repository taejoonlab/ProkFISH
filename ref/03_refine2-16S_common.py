...
filename_vulgar_base = os.path.basename(filename_vulgar)
filename_fa = '%s.v1.fa' % filename_vulgar_base.split('.')[1]
filename_out = filename_fa.replace('.v1.fa', '') + '.v2.fa'
filename_log = filename_fa.replace('.v1.fa', '') + '.v2.log'
